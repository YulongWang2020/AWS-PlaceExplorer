...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://qu051ryzx8.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.userGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['swlat', 'nelng', 'swlng', 'nelat', 'max'], ['body']);
        
        var userGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/user').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['swlat', 'nelng', 'swlng', 'nelat', 'max']),
            body: body
        };
